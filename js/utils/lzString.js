  ...
  const LZString = {
    ...
    decompressFromUint8Array(compressed) {
      if (!compressed) {
        ...
        const buf = Array.from(compressed.length / 2); // 2 bytes per character
